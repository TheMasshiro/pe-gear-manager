...
class SignInFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.student_year = customtkinter.CTkOptionMenu(self, values=["1st-Year", "2nd-Year", "3rd-Year", "4th-Year"], width=110)
        ...
        sign_up_button = customtkinter.CTkButton(self, text="Sign Up", font=("Inter", 15, "bold"),
                                                 fg_color="#0496ff", hover_color="#006ba6",
    ...
    def sign_up_popup(self):
        if not validation.validate_id(self.id_number.get()) or not validation.validate_phone_number(self.student_number.get()):
            CTkMessagebox(title="Sign Up Error", message="Please properly fill in the fields.", icon="cancel", option_1="OK", justify="center",
                          corner_radius=10)
        else:
            CTkMessagebox(title="Sign Up", message="Successfuly Registered", icon="check", option_1="OK", justify="center",
                          corner_radius=10)
...
class HistoryFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        status_button = customtkinter.CTkButton(self, text="Check History", font=("Inter", 14, "bold"))
        status_button.grid(row=2, column=0, columnspan=2, padx=20, pady=20, sticky="n")
