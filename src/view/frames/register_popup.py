...
class RegisterPopup(customtkinter.CTkToplevel):
    def __init__(self, master):
        ...
        student_id_label = customtkinter.CTkLabel(
            self, text="ID Number:", font=label_font
        )
        ...
        student_number_label = customtkinter.CTkLabel(
            self, text="Phone Number:", font=label_font
        )
        ...
        student_course_label = customtkinter.CTkLabel(
            self, text="Course:", font=label_font
        )
        ...
        register_button = customtkinter.CTkButton(
            self, text="Register", font=button_font
        )
        register_button.grid(
            row=7, column=0, columnspan=2, padx=30, pady=30, sticky="s"
        )
