...
class Equipments(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        equipment_tree.grid_rowconfigure((0, 1, 2, 3), weight=1)
        ...
        tree_label.grid(row=0, column=0, columnspan=4, padx=30, pady=(30, 50), sticky="n")
        ...
        sort_option = customtkinter.CTkSegmentedButton(
            equipment_tree, values=["Name", "Quantity", "Date"]
        )
        ...
        order_label.grid(row=2, column=0, padx=5, sticky="e")
        order_option = customtkinter.CTkSegmentedButton(
            equipment_tree, values=["↑", "↓"]
        )
        order_option.set("↑")
        order_option.grid(row=2, column=1, padx=5, sticky="w")

        search_label = customtkinter.CTkLabel(equipment_tree, text="Search:", font=label_font)
        search_label.grid(row=2, column=2, padx=5, sticky="e")
        search_entry = customtkinter.CTkEntry(equipment_tree, placeholder_text="Name")
        search_entry.grid(row=2, column=3, padx=5, sticky="w")
        ...
        tree.grid(row=3, column=0, columnspan=4, padx=30, pady=(20, 35), sticky="nswe")
        ...
        add_equipment_image = customtkinter.CTkImage(Image.open(asset_dir / "assets" / "inventory_image.png"),
            size=(90, 90))
        equipment_image = customtkinter.CTkLabel(add_equipment, text="", image=add_equipment_image)
