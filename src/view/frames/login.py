...
class Login(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        sign_in_label.grid(
            row=0, column=0, columnspan=2, padx=30, pady=(30, 50), sticky="n"
        )
        ...
        log_in_button.grid(
            row=3, column=0, columnspan=2, padx=30, pady=(20, 15), sticky="s"
        )
        ...
        register_button.grid(
            row=4, column=0, columnspan=2, padx=30, pady=(15, 20), sticky="s"
        )
        ...
        student_info_label.grid(
            row=0, column=0, columnspan=2, padx=20, pady=(30, 50), sticky="n"
        )

        student_id_label = customtkinter.CTkLabel(
            student_info_frame, text="ID Number:", font=label_font
        )
        ...
        student_name_label = customtkinter.CTkLabel(
            student_info_frame, text="Student Name:", font=label_font
        )
        ...
        student_number_label = customtkinter.CTkLabel(
            student_info_frame, text="Phone Number:", font=label_font
        )
        ...
        student_course_label = customtkinter.CTkLabel(
            student_info_frame, text="Course:", font=label_font
        )
        ...
        student_year_label = customtkinter.CTkLabel(
            student_info_frame, text="Year:", font=label_font
        )
        ...
        student_section_label = customtkinter.CTkLabel(
            student_info_frame, text="Section:", font=label_font
        )
    ...
    def show_register(self):
        if self.register_window is None or not self.register_window.winfo_exists():
            self.register_window = RegisterPopup(
                self
